...
contract Handler is Test {
    ...
    function depositCollateral(
        ...
        amountCollateral = bound(amountCollateral, 1, MAX_DEPOSIT_SIZE); //限制抵押数量，抵押数量不能为0
    ...
    function redeemCollateral(
        ...
        amountCollateral = bound(amountCollateral, 0, maxCollateralToRedeem); //限制赎回的数量，最大为用户自己拥有的数量。
